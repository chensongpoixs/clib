...
namespace chen {
	...
	public:
		...
		void set_int16(int32 index, const std::string key, int16 value);
		void set_uint16(int32 index, const std::string key, uint16 value);
	...
	public:
		...
		int16 get_int16(int64 index)const;
		uint16 get_uint16(int64 index)const;
